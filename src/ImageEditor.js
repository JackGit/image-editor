  ...
  $.fn.ImageEditor = function(options) {
    ...
    function ImageEditor($el, options) {
      ...
      var defaults = {
        ...
        height: 400,
        imageUrls: [],
        onAllImageLoaded: function() { console.log('all image loaded', this.images);}
      };
    ...
    ImageEditor.prototype = {
      ...
      _placeImage: function(image) {
        ...
        console.log('image center point', image.centerPoint);
      },
      ...
      _end: function(e) {
        ...
        console.log('image center point moved to', image.centerPoint);
      },
      ...
      replaceImage: function(url, index) {
        console.log('replaceImage not implemented yet');
      },

      setImage: function() {
        console.log('setImage not implemented yet');
      },

      removeImage: function(index) {
        console.log('removeImage not implemented yet');
      },

      removeAll: function() {
        console.log('removeAll not implemented yet');
      },
...
setTimeout(function() {
    ...
    editor = $('#container').ImageEditor({
      imageUrls: [
        'http://upload.wikimedia.org/wikipedia/en/2/24/Lenna.png', 
        'http://pngimg.com/upload/bush_PNG7216.png'
      ]
    });
